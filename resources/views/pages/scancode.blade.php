...
<!--
                        <div class="form-group{{ $errors->has('attachment') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Attachment</label>
                            <div class="col-md-6">
                                <input id="attachment" type="file" class="form-control" name="attachment" value="{{ old('attachment') }}" placeholder="67453 ..."  required autofocus>
