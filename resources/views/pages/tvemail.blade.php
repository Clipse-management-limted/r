...
<div class="container">
    <div class="row">
      <a class="btn btn-primary pull-right" href="{{ url('validate') }}">Validate Online E-Ticket </a>
        <div class="col-md-9 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Hard Copy Ticket Validation  </div>
